...
namespace Illuminate\Database\Eloquent\Relations {
    ...
    class HasMany {
        ...
        {
            return \Illuminate\Database\Eloquent\Relations\HasMany::createUpdateOrDelete($records);
        }
         ...
         * @static 
         */
        public static function createUpdateOrDeletePivot($records, $pivotAttributes = [])
        {
            return \Illuminate\Database\Eloquent\Relations\HasMany::createUpdateOrDeletePivot($records, $pivotAttributes);
        }
    ...
    class HasOneOrMany {
        ...
        public static function createUpdateOrDelete($records)
        {
            return \Illuminate\Database\Eloquent\Relations\HasOneOrMany::createUpdateOrDelete($records);
        }
        ...
        public static function createUpdateOrDeletePivot($records, $pivotAttributes = [])
        {
            return \Illuminate\Database\Eloquent\Relations\HasOneOrMany::createUpdateOrDeletePivot($records, $pivotAttributes);
        }
    ...
    class Relation {
        ...
        public static function createUpdateOrDeletePivot($records, $pivotAttributes = [])
        {
            return \Illuminate\Database\Eloquent\Relations\Relation::createUpdateOrDeletePivot($records, $pivotAttributes);
        }
    ...
    class BelongsToMany {
        ...
        public static function createUpdateOrDelete($records)
        {
            return \Illuminate\Database\Eloquent\Relations\BelongsToMany::createUpdateOrDelete($records);
        }
        ...
        public static function createUpdateOrDeletePivot($records, $pivotAttributes = [])
        {
            return \Illuminate\Database\Eloquent\Relations\BelongsToMany::createUpdateOrDeletePivot($records, $pivotAttributes);
        }
