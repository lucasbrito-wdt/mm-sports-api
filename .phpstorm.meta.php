...
'cache.stores.dynamodb.endpoint','cache.stores.octane.driver','cache.prefix','cdf.default_user_role_slug','cdf.delete_previous_access_tokens_on_login',
'cdf.api_version','cdf.locales','cdf.tenantTable','cdf.tenantColumn','cdf.tenantModels',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.E:\\wdt\\laravel-backend\\crudgerador\\public\\storage',
...
'permission_list.permission','queue.default','queue.connections.sync.driver','queue.connections.database.driver','queue.connections.database.connection',
...
'hashing.argon.verify','hashing.rehash_on_login','view.paths','view.compiled','telescope.enabled',
...
'web','api',);
        registerArgumentsSet('routes', 'telescope','auth',
'auth','authforgot.password','authpassword.reset','authverification.notice','authverification.verify',
'authverification.send','auth','auth','roles.index','roles.store',
'roles.show','roles.update','roles.destroy','roles','roles',
'roles','roles','permission.index','permission.store','permission.show',
'permission.update','permission.destroy','permission','permission','permission',
'permission','users.index','users.store','users.show','users.update',
'users.destroy','users','users',
'storage.local',);
