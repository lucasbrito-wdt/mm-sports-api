...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'permission_list.post' => 'array',
            'permission_list.comment' => 'array',
            'permission_list.tag' => 'array',
            'permission_list.category' => 'array',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','permission_list.auth','permission_list.manage',
'permission_list.users','permission_list.profile','permission_list.roles','permission_list.permission','permission_list.post',
'permission_list.comment','permission_list.tag','permission_list.category','queue.default','queue.connections.sync.driver',
...
'sanctum.middleware.authenticate_session','sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','telescope.enabled','telescope.domain',
