...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'cache.prefix' => 'string',
            'cdf.default_user_role_slug' => 'string',
            'cdf.delete_previous_access_tokens_on_login' => 'string',
            'cdf.api_version' => 'string',
            'cdf.locales' => 'array',
            'cdf.tenantTable' => 'string',
            'cdf.tenantColumn' => 'string',
            'cdf.tenantModels' => 'array',
            'cors.paths' => 'array',
            ...
            'filesystems.links.H:\CodifyTech\backend\cdf_generator\public\storage' => 'string',
            ...
            'permission_list.auth' => 'array',
            'permission_list.manage' => 'array',
            'permission_list.users' => 'array',
            'permission_list.profile' => 'array',
            'permission_list.roles' => 'array',
            'permission_list.permission' => 'array',
            'permission_list.contato' => 'array',
            ...
            'telescope.watchers.Laravel\Telescope\Watchers\BatchWatcher' => 'string',
            'telescope.watchers.Laravel\Telescope\Watchers\CacheWatcher.enabled' => 'string',
            'telescope.watchers.Laravel\Telescope\Watchers\CacheWatcher.hidden' => 'array',
            'telescope.watchers.Laravel\Telescope\Watchers\ClientRequestWatcher' => 'string',
            'telescope.watchers.Laravel\Telescope\Watchers\CommandWatcher.enabled' => 'string',
            'telescope.watchers.Laravel\Telescope\Watchers\CommandWatcher.ignore' => 'array',
            'telescope.watchers.Laravel\Telescope\Watchers\DumpWatcher.enabled' => 'string',
            'telescope.watchers.Laravel\Telescope\Watchers\DumpWatcher.always' => 'string',
            'telescope.watchers.Laravel\Telescope\Watchers\EventWatcher.enabled' => 'string',
            'telescope.watchers.Laravel\Telescope\Watchers\EventWatcher.ignore' => 'array',
            'telescope.watchers.Laravel\Telescope\Watchers\ExceptionWatcher' => 'string',
            'telescope.watchers.Laravel\Telescope\Watchers\GateWatcher.enabled' => 'string',
            ...
            'telescope.watchers.Laravel\Telescope\Watchers\JobWatcher' => 'string',
            'telescope.watchers.Laravel\Telescope\Watchers\LogWatcher.enabled' => 'string',
            'telescope.watchers.Laravel\Telescope\Watchers\LogWatcher.level' => 'string',
            'telescope.watchers.Laravel\Telescope\Watchers\MailWatcher' => 'string',
            'telescope.watchers.Laravel\Telescope\Watchers\ModelWatcher.enabled' => 'string',
            ...
            'telescope.watchers.Laravel\Telescope\Watchers\NotificationWatcher' => 'string',
            'telescope.watchers.Laravel\Telescope\Watchers\QueryWatcher.enabled' => 'string',
            ...
            'telescope.watchers.Laravel\Telescope\Watchers\RedisWatcher' => 'string',
            'telescope.watchers.Laravel\Telescope\Watchers\RequestWatcher.enabled' => 'string',
            ...
            'telescope.watchers.Laravel\Telescope\Watchers\ScheduleWatcher' => 'string',
            'telescope.watchers.Laravel\Telescope\Watchers\ViewWatcher' => 'string',
...
'cache.prefix','cdf.default_user_role_slug','cdf.delete_previous_access_tokens_on_login','cdf.api_version','cdf.locales',
'cdf.tenantTable','cdf.tenantColumn','cdf.tenantModels','cors.paths','cors.allowed_methods',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.H:\\CodifyTech\\backend\\cdf_generator\\public\\storage','ide-helper.filename','ide-helper.models_filename',
...
'ide-helper.additional_relation_return_types','ide-helper.enforce_nullable_relationships','ide-helper.post_migrate','ide-helper.macroable_traits','jwt.secret',
...
'permission_list.auth','permission_list.manage','permission_list.users','permission_list.profile','permission_list.roles',
'permission_list.permission','permission_list.contato','queue.default','queue.connections.sync.driver','queue.connections.database.driver',
...
'auth','auth','authforgot.password','authpassword.reset','authverification.notice',
'authverification.verify','authverification.send','auth','auth','roles.index',
'roles.store','roles.show','roles.update','roles.destroy','roles',
'roles','roles','roles','permission.index','permission.store',
'permission.show','permission.update','permission.destroy','permission','permission',
'permission','permission','users.index','users.store','users.show',
'users.update','users.destroy','users','users','contatocontatos.index',
'contatocontatos.store','contatocontatos.show','contatocontatos.update','contatocontatos.destroy','storage.local',);
...
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded',
'H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','H:.CodifyTech.backend.cdf_generator.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER','TELESCOPE_ENABLED',
'PHP_CLI_SERVER_WORKERS','BCRYPT_ROUNDS','LOG_CHANNEL','LOG_STACK','LOG_DEPRECATIONS_CHANNEL',
'LOG_LEVEL','DB_CONNECTION','DB_DATABASE','DB_HOST','DB_PORT',
...
'CDF_API_VERSION','CDF_DIR_FRONT_END','CDF_FRONT_END_URL','CDF_DELETE_PREVIOUS_ACCESS_TOKENS_ON_LOGIN','CDF_DEFAULT_ROLE_SLUG',
'CDF_EMAIL_VERIFICATION','JWT_SECRET','JWT_TTL',);
